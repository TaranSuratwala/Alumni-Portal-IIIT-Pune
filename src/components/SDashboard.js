  ...
  return (
    <div>
        ...
        <div className='px-[20px] pb-[50px]'>
            ...
            <div className='flex flex-wrap justify-between gap-[25px] w-full mt-[40px]'>
                {
            ...
            <div className='dash-data flex  gap-[20px] mt-[40px]'>
                <div className='flex-1 dash-data-items'>
            ...
            <div className='mt-[50px]'>
                ...
                <div className='flex flex-wrap gap-[20px] w-full'>
                        ...
                        .map((a,i)=>{
                            return(
                            <div key={a._id} className='dash-alumni-directory bg-white flex items-center w-[380px] p-[20px] rounded-md justify-between shadow-md hover:shadow-[0_0_5px_1px_rgba(0,0,0,0.1)] transition-all duration-200'>
                                ...
                                <div className='px-[18px] py-[8px] text-sm rounded-md bg-[#f0f4f8]' 
